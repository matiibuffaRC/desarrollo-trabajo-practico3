    ...
    return (
        <div className="mb-10">
            <div className="relative w-full max-w-xl m-auto">
                ...
                <button className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full bg-[#1DB954] p-3 text-black transition-transform duration-300 hover:scale-105 hover:cursor-pointer">
                    <svg
