...
function HomePage({ token }) {
    ...
    const handleToggleFavorite = (e, artist) => {
        ...
        if (alreadyExists) {
            ...
            updatedFavorites = [
                ...favorites,
                normalizeArtistForFavorite(artist),
            ];
        }
    ...
    const handleSearch = async (searchKey) => {
        ...
        try {
            ...
            setError(
                "Problemas de CORS. Cargando artistas de simulación.",
            );
    ...
    return (
        <main className="min-h-screen bg-[#121212] px-4 py-10 text-white">
            <section className="mx-auto max-w-6xl">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                            {favorites.map((fav) => (
                                <div
                                    ...
                                    onClick={() =>
                                        navigate(
                                            `/artist/${fav.id}?name=${encodeURIComponent(
                                                fav.name,
                                            )}`,
                                        )
                                    }
                ...
                {/* RESULTADOS */}
                <h2 className="text-3xl font-bold m-2 mt-8">
